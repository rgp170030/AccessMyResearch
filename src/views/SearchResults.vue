...
<!--          &lt;!&ndash; Next is the button that displays the results from querying DOAJ &ndash;&gt;-->
<!--					&lt;!&ndash; <div class="accordion" role="tablist">-->
...
<!--								<b-button-->
<!--									block-->
<!--									v-b-toggle.doajAccordion-->
<!--									variant="primary"-->
<!--									>DOAJ: About-->
<!--									{{ results_doaj.length }} results ({{-->
<!--										timeTotal-->
<!--									}}-->
<!--									ms)</b-button-->
<!--								>-->
...
<!--								<b-card-body>-->
<!--									<div-->
<!--										v-for="(result, i) in results_doaj"-->
<!--										:key="i + result.bibjson.title"-->
<!--									>-->
...
<!--										</p>-->
<!--										<p-->
<!--											v-for="(link, iii) in result.bibjson-->
<!--												.link"-->
<!--											:key="iii + link.url"-->
<!--										>-->
<!--											Link/URL:-->
...
<!--			axios-->
<!--				.get(-->
<!--					`https://doaj.org/api/v1/search/articles/${this.$route.query.text}?page=1&pageSize=100`-->
<!--				)-->
<!--				.then((response) => {-->
...
<!--			axios-->
<!--				.get(-->
<!--					`https://api.unpaywall.org/v2/search/?query=${this.$route.query.text}&email=your_email&is_oa=true`-->
<!--				)-->
<!--				.then((response) => {-->
<!--					this.elapsed_time = response.data.elapsed_seconds;-->
...
<!--					hit._source.authors = this.arrayToString(-->
<!--						hit._source.authors-->
<!--					);-->
...
<!--				this.searchStatus =-->
<!--					"Recognized DOI. Checking Crossref.org for info...";-->
